    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if (!isDesktop) {
                ...
                const triggerOn = window.innerHeight * 0.5;
    ...
    return (
        <div className={`calc-container ${isMergedWithForm ? 'is-merged' : ''} ${marginBase === 0 ? 'is-zero' : ''}`}>
            <div className="calc-sticky-boundary">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            style={{
                                ...
                                // Smoothly bridge the gap on desktop
                ...
                {/* ADDONS - Now a direct child of grid */}
                <motion.div
                    className="addons-card-row"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.6 }}
                >
                    <div className="addons-section glass-panel">
