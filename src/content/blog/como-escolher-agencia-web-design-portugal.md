...
## 2. Perceba a Tecnologia Utilizada

A tecnologia por trás do site afeta a velocidade, segurança, custo de manutenção e longevidade do projeto. Pergunte sempre:
...
## 3. Verifique o Que Está Incluído

Muitas agências apresentam preços baixos mas cobram à parte tudo o que importa. Confirme sempre se o orçamento inclui:

- Design responsivo (mobile, tablet, desktop)
- SEO técnico básico (meta tags, sitemap, schema markup)
- Formulários de contacto funcionais
- Política de privacidade e cookies (GDPR)
- Testes em múltiplos dispositivos e browsers
- Formação para gerir o site de forma autónoma
- Suporte pós-lançamento (e por quanto tempo?)

---

## 4. Peça Referências e Case Studies
...
## 5. Avalie a Comunicação Antes de Assinar

A relação com a agência é tão importante quanto o produto final. Durante o processo de orçamento, observe:

- **Respondem rapidamente?** Se demoram dias a responder a um email de proposta, imagine durante o projeto
...
## 6. Desconfie de Preços Demasiado Baixos

Um site de qualidade profissional tem custos reais: horas de design, desenvolvimento, testes, SEO, comunicação, gestão de projeto. Um orçamento de 300€ para um site completo é matematicamente impossível de executar com qualidade.

Preços abaixo do mercado geralmente significam:
- Templates genéricos com mínima personalização
- Sem SEO ou com SEO superficial
- Suporte inexistente após entrega
- Código mal estruturado, difícil de manter ou expandir

Consulte a nossa [calculadora de orçamento](/orcamento) para ter uma referência do que projetos semelhantes ao seu costumam custar.

---

## 7. Contrato e Propriedade do Código
...
## Checklist Rápida: Perguntas a Fazer à Agência

- Posso ver o portfólio completo com links ao vivo?
- Que tecnologia utilizam e porquê?
- Qual é a pontuação típica dos vossos sites no Lighthouse?
- O que está incluído no orçamento? E o que não está?
- Qual é o prazo realista para este projeto?
- Quantas rondas de revisão estão incluídas?
- Como funciona o suporte após lançamento?
